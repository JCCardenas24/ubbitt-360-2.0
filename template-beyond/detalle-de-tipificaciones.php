<div class="reports_info_contents">
  <div class="d-flex wid-100 justify-content-end">
    ...
    <a href="./assets/reportes/info.zip" class="pdf_button  mr-5" download><i class="fa fa-download"
    ...
    <tbody>
      <tr>
        ...
        <td>
          ...
          <a type="button" class="" data-toggle="modal" data-target="#modal-delete-report2">
  ...
  <!-- Modal delete report -->
  <div class="modal fade modal-delete-report" id="modal-delete-report2" tabindex="-1"
    aria-labelledby="modal-delete-report2Label" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-body">
          <img class="alert_icon" src="./assets/images/alert_icon.svg" alt="">
          <p class="">¿Estas seguro que deseas eliminar este reporte?</p>
          <div class="d-flex justify-content-end align-items-center">
            <a class="btn_cancel" data-dismiss="modal">Cancelar</a>
            <a class="btn_continue_delete_report" data-dismiss="modal">Continuar</a>
          </div>
        </div>
      </div>
    </div>
...
<div class="view_upload_report_form" style="display: none;">
  <a class="cancel_upload_report">
    <i class="ri-arrow-left-s-line"></i> Regresar a la lista</a>
        ...
        <div class="main-wrapper">
          <div class="upload-main-wrapper">
            <div class="upload-wrapper">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" width="18.001" height="18.006" viewBox="0 0 18.001 18.006">
              ...
              <div class="file-success-text">
                <svg version="1.1" id="check" xmlns="http://www.w3.org/2000/svg"
                  ...
                  <circle style="fill:rgba(0,0,0,0);stroke:#ffffff;stroke-width:10;stroke-miterlimit:10;" cx="49.799"
                    cy="49.746" r="44.757" />
                  <polyline
