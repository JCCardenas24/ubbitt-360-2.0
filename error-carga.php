		    ...
		    <div class="h-400">
			  	<div class="col-md-12 pr-0 pl-0 h100">
					<div class="mt-50 col-md-6 mx-auto mt-200 text-center div-white pd-20 rounded">
                        ...
                        <h4 class="c-header font-weight-800 text-center text-uppercase mt-20">Error al cargar el archivo</h4>
						...
						<div class="text-center mt-30 mb-5">
							<a href="carga-reporte.php" class="btn btn-first c-white col-3 font-weight-800">Continuar</a>
						</div>
					</div>
				</div>
	  		</div>
