<ul class="nav nav-pills level-four" id="freemium-inbound-reportes-options" role="tablist">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link ">Productividad de asesores</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link ">Detalle de tipificaciones</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link ">De calidad diario</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link ">General de calidad</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link ">Resultado de calibraciones</a>
    </li>
</ul>
