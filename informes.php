...
<head>
    ...
    <title>Panel producción cobranza</title>
</head>
            ...
            <div class="container pb-15">
                <div class="col-md-12 pr-0 pl-0">
                    <div class="d-flex justify-content-between">
                        <h5 class="c-header font-weight-800 m-0 d-flex align-items-center">Panel producción cobranza
                        </h5>
                        <div class="row col-md-9 d-flex align-items-center justify-content-end">
                            <div class="form-group col-md-5 d-flex m-0">
                                <div id="reportrange_informes" class="range-pick">
                    ...
                    <div class="mt-30">
                        <div class="col-12 mx-auto row">
                            ...
                            <div class="col-md-4">
                                <div class="div-orange rounded10 shadow-div h-150">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="pd-20">
                                            <p class="m-0 c-white text-uppercase">Base de saneamiento</p>
                                            <p class="font-size-30 font-weight-bold c-white"><?= $base_saneamiento ?>
                                            </p>
                                        </div>
                                        <div
                                            class="circle-white d-flex justify-content-center align-items-center mr-30">
                                    ...
                                    <div class="bar-kpi">
                                        <div class="bar-progress-kpi" style="width: <?= $kpis_base_saneamiento ?>%;">
                                        </div>
                                        <div class="d-flex justify-content-between mb-5">
                                            <span class="c-white">KPIs</span>
                                            <span class="c-white"><?= $kpis_base_saneamiento ?>%</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
