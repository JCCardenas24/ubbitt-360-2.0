										...
										<div class="col-12 text-center pos-check">
											<div class="form-check p-0 prt-10">
												...
												<label class="form-check-label" for="defaultCheck1">
													<span class="font-size-14 c-gray">Acepto <a href="#" class="c-terminos">Términos y Condiciones</a></span>
												</label>
											</div>
										</div>
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="text-center p-25">
						...
						<p class="c-header">Introduce tu correo electrónico <br> para que un agente de RH pueda modificar la contraseña</p>
