...
let basicdoughnut_concentrado_ventas = echarts.init(document.getElementById('premium_resumen_concentrado_ventas_chart'));
let options = {
    // Add title
    title: {
...
let horizontal_double_bar = echarts.init(document.getElementById('edad_segmento_chart'));
let options_edad = {
    title: {
        text: 'Edad'
...
let horizontal_region_bar = echarts.init(document.getElementById('region_segmento_chart'));
let options_region = {
    title: {
        text: 'Región'
    ...
    yAxis: {
        type: 'category',
        data: ['Nuevo León', 'Chihuahua', 'Jalisco', 'Ciudad de México', 'Estado de México']
    },
    series: [{
        type: 'bar',
        data: [20, 21, 43, 46, 56]
...
let horizontal_top_7_leads = echarts.init(document.getElementById('leads_totales_top_7'));
...
// charts leads 2
let horizontal_top_5_leads = echarts.init(document.getElementById('leads_totales_top_5'));
...
// Horarios chart
let horarios_double_bar = echarts.init(document.getElementById('horarios_chart'));
let options_horarios = {
    ...
    yAxis: {
        type: 'category',
        data: ['6:00-9:00', '10:00-13:00', '14:00-16:00', '15:00-20:00', '21:00-00.00']
    },
    series: [{
            name: 'Impresiones',
            type: 'bar',
...
$('#premium-marketing-campaign-1-segmento-tab').on('shown.bs.tab', function(event) {
    event.target // newly activated tab
    event.relatedTarget // previous active tab
...
// Rendimiento chart
let rendimiento_mixed_chart = echarts.init(document.getElementById('redimiento_diario_chart_wrapper'));
let options_redimiento_data = {
    ...
    xAxis: [{
        type: 'category',
        data: ['Día 1', 'Día 2', 'Día 3', 'Día 4', 'Día 5', 'Día 6', 'Día 7'],
        axisPointer: {
            type: 'shadow'
        }
    }],
