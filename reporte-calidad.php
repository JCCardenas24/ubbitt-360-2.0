                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="row col-6 mx-auto">
                                            <div class="col">
                                                <a href="./upload/" download><i class="fa fa-download"
                                                        aria-hidden="true" title="Descargar archivo"></i></a>
                                            </div>
                                            <div class="col">
                                                <a href="#" data-toggle="modal" data-target="#eliminarReporte"><i
                                                        class="fa fa-trash" aria-hidden="true"
                                                        title="Eliminar archivo"></i></a>
                                            </div>
                                        </div>
                                    </td>
                                </tr>
